...
excerpt: "A tuned Random Forest pipeline that recommends crops from soil and climate data, benchmarked against three baseline models with SHAP-based interpretability.<br/><img src='/images/crop-portfolio.png'>"
